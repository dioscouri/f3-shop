...
class Manufacturers extends \Admin\Controllers\BaseAuth 
{
    ...
    public function display()
    {
        ...
        echo $view->render('Tienda/Admin/Views::manufacturers/list.php');
    }
    ...
    public function getDatatable()
    {
        ...
        $view = new \Dsc\Template;
        $html = $view->renderLayout('Tienda/Admin/Views::manufacturers/list_datatable.php');
    ...
    public function getAll()
    {
        ...
        $view = new \Dsc\Template;
        $html = $view->renderLayout('Tienda/Admin/Views::manufacturers/list_parents.php');
    ...
    public function getCheckboxes()
    {
        ...
        $view = new \Dsc\Template;
        $html = $view->renderLayout('Tienda/Admin/Views::manufacturers/checkboxes.php');
    ...
    public function selectList( $selected=null )
    {
        ...
        $view = new \Dsc\Template;
        echo $view->renderLayout('Tienda/Admin/Views::manufacturers/list_parents.php');
    }
}