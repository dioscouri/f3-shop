...
<div class="row table-actions">
    <div class="col-md-6 col-lg-4 input-group">
        <select id="bulk-actions" name="bulk_action" class="form-control">
            ...
            <option value="delete" data-action="./admin/tienda/categories/delete">Delete</option>
        </select>
        <span class="input-group-btn">
...
<table class="table table-striped table-bordered table-hover table-highlight table-checkable">
    ...
    <?php foreach ($list['subset'] as $item) { ?>
        <tr>
            ...
            <td class="">
                <a href="./admin/tienda/category/<?php echo $item->_id; ?>/edit">
            ...
            <td class="text-center">
                <a class="btn btn-xs btn-secondary" href="./admin/tienda/category/<?php echo $item->_id; ?>/edit">
                    <i class="fa fa-pencil"></i>
                </a>
                &nbsp;
                <a class="btn btn-xs btn-danger" data-bootbox="confirm" href="./admin/tienda/category/<?php echo $item->_id; ?>/delete">
