...
<form id="detail-form" action="./admin/tienda/category/<?php echo $item->get( $model->getItemKey() ); ?>" class="form" method="post">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="form-actions">
                ...
                <div>
                    ...
                    &nbsp;
                    <a class="btn btn-default" href="./admin/tienda/categories">Cancel</a>
                </div>
