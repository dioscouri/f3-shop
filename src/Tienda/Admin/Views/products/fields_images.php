<div class="col-md-8">
    ...
    <?php foreach ((array) $flash->old('relatedimages') as $key=>$relatedimage) { ?>
        <fieldset class="template well clearfix">
            <a class="remove-relatedimage btn btn-xs btn-danger pull-right" onclick="TiendaRemoveRelatedImage(this);" href="javascript:void(0);">
...
<div class="col-md-4 col-sidebar-right">
    ...
    jQuery(document).ready(function(){
        ...
        TiendaRemoveRelatedImage = function(el) {
