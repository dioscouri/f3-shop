        ...
        <div class="portlet">
            ...
            <div class="">
                <div id="categories" class="list-group">
                    ...
                    <?php echo $this->renderLayout('Tienda/Admin/Views::categories/checkboxes.php'); ?>
                    </div>
                    ...
                    <div class="list-group-item">
                        ...
                        Dsc.refreshCategories = function(r) {
                            ...
                            var request = jQuery.ajax({
                                type: 'post', 
                                url: './admin/tienda/categories/checkboxes',
                                data: form_data
                            }).done(function(data){
                        ...
                        <div id="addCategoryForm" class="collapse">
                            <div class="panel-body">
                                ...
                                <div id="quick-form" action="./admin/tienda/category/add" data-callback="Dsc.refreshCategories" data-message_container="quick-form-response-container">
                                ...
                                <div id="parents" class="form-group">
                                    <?php echo \Dsc\Request::internal( "\Tienda\Admin\Controllers\Categories->selectList" ); ?>                    
                                </div>
                                <!-- /.form-group -->        
