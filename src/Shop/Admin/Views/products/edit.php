...
<form id="detail-form" class="form" method="post">
	...
	<ul class="nav nav-tabs">
		...
		<li>
		 ...
		 <li>
			<a href="#tab-specs" data-toggle="tab"> Specs / Attributes </a>
		</li>
		 <li>
			<a href="#tab-ymm" data-toggle="tab"> Year Make Model Mapping </a>
		</li>
	...
	<div class="tab-content padding-10">
		...
		<div class="tab-pane" id="tab-specs">
			...
			<?php echo $this->renderLayout('Shop/Admin/Views::products/fields_specs.php'); ?>
		...
		<div class="tab-pane" id="tab-ymm">
			...
			<?php echo $this->renderLayout('Shop/Admin/Views::products/fields_ymm.php'); ?>
